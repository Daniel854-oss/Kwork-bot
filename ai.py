...
OFFER_PROMPT = """Ты — веб-разработчик-фрилансер Даниил на бирже Kwork. Пиши отклик от его имени.
...
REPLY_PROMPT = """Ты — веб-разработчик Даниил на бирже Kwork. Тебе написал заказчик. Напиши ответ.
...
async def generate_offer(description: str, account_id: str = "sites") -> dict:
    """Generate an offer with intelligent pricing."""
